...
Menu::widget([
    'items' => [
        ['label' => 'Home', 'header' => true],
        [
            'icon' => 'fa fa-cogs',
            'label' => 'Products',
            'items' => [
                ['label' => 'Home', 'header' => true,'badge' => Badge::widget(
                    ['label' => '1', 'type' => Badge::TYPE_SUCCESS]
                ),],
                ...
                [
                    ...
                    'items' => [
                        [
                            ...
                            'url' => ['site/index'],
                            'badge' => Badge::widget(
                                ['label' => '3', 'type' => Badge::TYPE_SUCCESS]
                            ),
                        ],
                    ]
                ],
...
<!-- <div class="page-sidebar-wrapper">
    <div class="page-sidebar navbar-collapse collapse">
        <ul class="page-sidebar-menu page-header-fixed" data-keep-expanded="false" data-slide-speed="200">
